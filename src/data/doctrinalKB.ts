...
{
  id: "bio-01",
  keywords: ["biografía", "vida", "nacimiento", "quién fue", "trincado", "joaquín", "historia", "uruguay", "salto", "biografia", "quien fue", "joaquin"],
...
{
  id: "bio-02",
  keywords: ["obras", "libros", "escritos", "publicaciones", "bibliografía", "cuántos libros", "bibliografia", "cuantos libros"],
...
{
  id: "bio-03",
  keywords: ["muerte", "fallecimiento", "partió", "1935", "buenos aires", "últimos días", "partio", "ultimos dias"],
...
{
  id: "emecu-01",
  keywords: ["emecu", "escuela", "magnético", "espiritual", "comuna", "universal", "qué es", "magnetico", "que es"],
...
{
  id: "emecu-02",
  keywords: ["inscribirse", "registrarse", "unirse", "ingresar", "incorporarse", "requisitos", "cómo unirse", "como unirse"],
...
{
  id: "emecu-03",
  keywords: ["grados", "13", "trece", "niveles", "estudio", "progresión", "avance", "estructura", "progresion"],
...
{
  id: "emecu-04",
  keywords: ["templo", "sede", "lugar", "reunión", "circunscripción", "donde", "reunion", "circunscripcion"],
...
{
  id: "creador-01",
  keywords: ["dios", "creador", "qué es dios", "existe", "naturaleza de dios", "que es dios"],
...
{
  id: "creador-02",
  keywords: ["dios castiga", "infierno", "castigo divino", "ira de dios", "pecado", "condenación", "demonio", "diablo", "condenacion"],
...
{
  id: "facultades-01",
  keywords: ["facultades", "siete", "7", "espirituales", "percepción", "memoria", "imaginación", "atención", "juicio", "razón", "voluntad", "percepcion", "imaginacion", "atencion", "razon"],
...
{
  id: "facultades-02",
  keywords: ["razón", "racional", "razonar", "pensamiento", "lógica", "inteligencia", "razon", "logica"],
...
{
  id: "espiritu-01",
  keywords: ["espíritu", "alma", "cuerpo", "triple", "naturaleza", "ser humano", "espiritu"],
...
{
  id: "espiritu-02",
  keywords: ["muerte", "morir", "qué pasa después", "fin", "eternidad", "inmortalidad", "que pasa despues"],
...
{
  id: "reencarnacion-01",
  keywords: ["reencarnación", "renacer", "reencarnar", "vidas", "pasadas", "múltiples", "reencarnacion", "multiples"],
...
{
  id: "reencarnacion-02",
  keywords: ["reencarnación animal", "perro", "gato", "animal", "migración", "reencarnacion animal", "migracion"],
...
{
  id: "magnetismo-01",
  keywords: ["magnetismo", "fluido", "vital", "fuerza", "energía", "magnético", "energia", "magnetico"],
...
{
  id: "magnetismo-02",
  keywords: ["pases", "curación", "sanación", "imposición", "manos", "curar", "curacion", "sanacion", "imposicion"],
...
{
  id: "mediumnidad-01",
  keywords: ["mediumnidad", "médium", "espiritismo", "comunicación", "canal", "medium", "comunicacion"],
...
{
  id: "mediumnidad-02",
  keywords: ["obsesión", "peligro", "riesgo", "posesión", "maligno", "negativo", "obsesion", "posesion"],
...
{
  id: "moral-02",
  keywords: ["regla de oro", "amar", "prójimo", "tratar", "respeto", "ética", "projimo", "etica"],
...
{
  id: "amores-01",
  keywords: ["cinco amores", "5 amores", "qué son", "amores universales", "que son"],
...
{
  id: "amores-02",
  keywords: ["amor propio", "amarse", "amor a sí mismo", "egoísmo", "egoísta", "amor a si mismo", "egoismo", "egoista"],
...
{
  id: "religion-01",
  keywords: ["religión", "iglesia", "católica", "cristiana", "sacerdote", "cura", "pastor", "religion", "catolica"],
...
{
  id: "religion-02",
  keywords: ["jesús", "cristo", "dios hecho hombre", "hijo de dios", "salvador", "jesus"],
...
{
  id: "causa-efecto-01",
  keywords: ["causa", "efecto", "karma", "consecuencia", "ley natural", "retribución", "retribucion"],
...
{
  id: "ciencia-fe-01",
  keywords: ["ciencia", "fe", "razón", "científico", "creencia", "demostración", "razon", "cientifico", "demostracion"],
...
{
  id: "atomica-01",
  keywords: ["átomo", "creación", "atómica", "materia", "fluido", "semilla", "atomo", "creacion", "atomica"],
...
{
  id: "instinto-01",
  keywords: ["instinto", "instintivo", "animal", "instintos", "vs razón", "vs razon"],
...
{
  id: "albedrío-01",
  keywords: ["libre albedrío", "libertad", "libre voluntad", "destino", "fatalismo", "determinismo", "libre albedrio"],
